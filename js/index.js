$(document).ready(function() {
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <div class="form-check mt-2">
                  <input class="form-check-input select-book" type="checkbox" value="" id="check-${title.replace(/\s+/g, '')}">
  ...
  $('#confirm-add-to-shelf').click(function() {
    ...
    if (selectedBooks.length > 0 && shelf) {
      // Store selected books and shelf in localStorage
      ...
      // Clear the selected books and close the modal
      selectedBooks = [];
      $('#shelfModal').modal('hide');
      alert('Books added to shelf!');
    } else {
      alert('Select a shelf to add the books.');
    }
  });
});
function displayError() {
